export const translations = {
  fr: {
    hero: {
      ...
      subtitle:
        "Betwixt n'invente rien à partir de rien. Il interpole entre tes poses, dessinées à la main — sans jamais dessiner à ta place.",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "Betwixt génère rapidement les images intermédiaires manquantes. L'algorithme analyse la structure de ton personnage pour créer une transition fluide, fidèle à ton trait.",
        },
        {
          number: "03",
  ...
  en: {
    hero: {
      ...
      subtitle:
        "Betwixt doesn't invent anything from nothing. It interpolates between your poses, drawn by hand — it never draws for you.",
      cta: "Join the beta",
    },
    problem: {
      eyebrow: "THE PROBLEM",
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description:
            "Betwixt quickly generates the missing in-between frames. The algorithm analyzes your character's structure to create a smooth transition, true to your line art.",
        },
        {
          number: "03",
